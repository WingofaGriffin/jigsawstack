A sample Jupyter workbook demonstrating [Jigsawstack's vOCR API](https://docs.jigsawstack.com/examples/ai/vocr) to compare images based on AI generated tags.
